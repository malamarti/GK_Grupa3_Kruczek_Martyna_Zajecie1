...
void GenerateTextures()
{
	...
	GLboolean error = load_targa("ura0fss1.tga", width, height, format, type, pixels);
	...
	glGenTextures(1, &URAN);

	// dowiązanie stanu tekstury
	glBindTexture(GL_TEXTURE_2D, URAN);
...
int main(int argc, char *argv[])
{
	...
	glutAddMenuEntry("Wenus", URAN_TEX);
